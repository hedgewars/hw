...
pub struct GameField {
    pub(crate) collision: land2d::Land2D<u16>,
    pub(crate) pixels: land2d::Land2D<u32>,
    pub(crate) landgen_parameters: Option<LandGenerationParameters<u16>>,
}
#[no_mangle]
