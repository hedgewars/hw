...
cd SDL_image && git apply ../../hedgewars/project_files/HedgewarsMobile/bootstrap/SDL_image.patch && cd ..
# SDL_image
git clone --branch release-2.8.1 --single-branch https://github.com/libsdl-org/SDL_mixer.git && \
cd SDL_mixer && git apply ../../hedgewars/project_files/HedgewarsMobile/bootstrap/SDL_mixer.patch && cd ..
# SDL_net
git clone --branch release-2.2.0 --single-branch https://github.com/libsdl-org/SDL_net.git && \
cd SDL_net && git apply ../../hedgewars/project_files/HedgewarsMobile/bootstrap/SDL_net.patch && cd ..
# SDL_ttf
git clone --branch release-2.24.0 --single-branch https://github.com/libsdl-org/SDL_ttf.git && \
cd SDL_ttf && git apply ../../hedgewars/project_files/HedgewarsMobile/bootstrap/SDL_ttf.patch && \
