...
function GetVariables()
  ...
  m5DenseDead = tonumber(GetCampaignVar("M4DenseDead"))
  ...
  m5ChiefDead = tonumber(GetCampaignVar("M4ChiefDead"))
  m4WaterDead = tonumber(GetCampaignVar("M4WaterDead"))
  m5WaterDead = tonumber(GetCampaignVar("M4WaterDead"))
  m4BuffaloDead = tonumber(GetCampaignVar("M4BuffaloDead"))
  m5BuffaloDead = tonumber(GetCampaignVar("M4BuffaloDead"))
  m5WiseDead = tonumber(GetCampaignVar("M4BuffaloDead"))
  m5GirlDead = tonumber(GetCampaignVar("M4BuffaloDead"))
end
