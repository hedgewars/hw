...
RoomNamePrompt::RoomNamePrompt(QWidget* parent, const QString& roomName)
    : QDialog(parent) {
  setModal(true);
  ...
  connect(cbSetPassword, &QAbstractButton::toggled, this,
          &RoomNamePrompt::checkBoxToggled);
}

QString RoomNamePrompt::getRoomName() { return leRoomName->text(); }

QString RoomNamePrompt::getPassword() { return lePassword->text(); }
