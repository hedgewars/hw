...
class SmartLineEdit : public HistoryLineEdit
{
    ...
    private:
     ...
     bool m_hasJustMatched;  ///< whether this widget just did an
                             ///< auto-completion
     QString m_prefix;  ///< prefix of the text replacement this widget just did
     QString m_postfix;  ///< postfix of the text replacement this widget
                         ///< just did

     /**
      * @brief Autocompletes the contents based on the known commands and/or
      * names.
      */
     void autoComplete();
