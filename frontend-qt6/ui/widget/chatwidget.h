...
class HWChatWidget : public QWidget {
 ...
 public:
  ...
  void setIgnoreListKick(bool enabled);  ///< automatically kick people on
                                         ///< ignore list (if possible)
 ...
 private:
   ...
   * @return true if the sender is somebody else and the message contains a
   * highlight, otherwise false
   */
  ...
  void printChatString(const QString& nick, const QString& str,
                       const QString& cssClassPart, bool highlight);
 ...
 private:
  ...
  QList<QRegularExpression>
      m_highlights;  ///< regular expressions used for highlighting
  bool notify;
