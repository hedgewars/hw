...
void AbstractPage::initPage() {
  ...
  if (flld != NULL) bottomLeftLayout->addLayout(flld, 0);
  ...
  if (fld != NULL) pageLayout->addLayout(fld, 1, 2);
...
QPushButtonWithSound* AbstractPage::formattedButton(const QString& name,
                                                    bool hasIcon) {
...
QPushButton* AbstractPage::formattedSoundlessButton(const QString& name,
                                                    bool hasIcon) {
...
QPushButtonWithSound* AbstractPage::addButton(const QString& name,
                                              QGridLayout* grid, int row,
                                              int column, int rowSpan,
                                              int columnSpan, bool hasIcon,
...
QPushButton* AbstractPage::addSoundlessButton(const QString& name,
                                              QGridLayout* grid, int row,
                                              int column, int rowSpan,
                                              int columnSpan, bool hasIcon,
                                              Qt::Alignment alignment) {
...
QString* AbstractPage::getDefaultDescription() { return defautDesc; }

void AbstractPage::triggerPageEnter() { Q_EMIT pageEnter(); }

void AbstractPage::triggerPageLeave() { Q_EMIT pageLeave(); }
