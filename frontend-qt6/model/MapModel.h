...
class MapModel : public QStandardItemModel {
 ...
 private:
  ...
  /**
   * @brief Creates a QStandardItem, that holds the map info and item
   * appearance. The used role for the data is Qt::UserRole + 1.
   ...
   */
  static QStandardItem *infoToItem(const QIcon &icon, const QString &caption,
